...
class SetblockCommandTestCase(unittest.TestCase):
    ...
    def test_up_to_data_tag(self):
        ...
        self.assertEqual(str(cmd), 'setblock 1 2 3 minecraft:dropper[facing=up]{Lock:password} destroy')
    ...
    def test_with_block(self):
        cmd = commands.setblock(
            ...
            block=BlockEntity(
                ...
                block_state=dict(facing='up'),
                data_tag={'Lock': 'password'}))
        self.assertEqual(str(cmd), 'setblock 1 2 3 minecraft:dropper[facing=up]{Lock:password}')
