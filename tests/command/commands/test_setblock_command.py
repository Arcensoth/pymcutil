...
class SetblockCommandTestCase(unittest.TestCase):
    ...
    def test_default_optionals(self):
        cmd = commands.setblock(
            ...
            block_id='dropper',
            data_tag={})
        self.assertEqual(str(cmd), 'setblock 1 2 3 dropper default replace {}')
    ...
    def test_up_to_old_block_handling(self):
        ...
        self.assertEqual(str(cmd), 'setblock 1 2 3 dropper facing=up destroy')
    ...
    def test_up_to_data_tag(self):
        ...
        self.assertEqual(str(cmd), 'setblock 1 2 3 dropper facing=up destroy {Lock:password}')
